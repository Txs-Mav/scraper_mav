  ...
  return (
    <div className="min-h-screen bg-[#fafbfc] dark:bg-[#121415] text-gray-900 dark:text-white overflow-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        ...
        {/* Floating squares */}
        <div className="absolute top-20 left-[10%] w-16 h-16 border border-emerald-200/30 dark:border-emerald-500/10 rounded-lg animate-float-slow" />
        <div className="absolute top-40 right-[15%] w-24 h-24 border border-emerald-200/20 dark:border-emerald-500/10 rounded-xl animate-float-medium" />
        ...
        <div className="absolute top-[30%] right-[8%] w-12 h-12 bg-emerald-100/40 dark:bg-emerald-500/5 rounded-md animate-float-slow" />
        ...
        <div className="absolute bottom-[40%] right-[25%] w-14 h-14 bg-emerald-100/30 dark:bg-emerald-500/5 rounded-lg animate-float-fast" />
        <div className="absolute top-[75%] right-[12%] w-20 h-20 border border-emerald-200/20 dark:border-emerald-500/8 rounded-xl animate-float-slow" />
      ...
      <header className="relative z-10 px-6 py-6">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          <Link href="/" className="flex items-center gap-3 group">
            <div className="relative h-11 w-11 flex-shrink-0 rounded-xl bg-gradient-to-br from-white to-gray-100 dark:from-[#242628] dark:to-[#1c1e20] shadow-lg shadow-black/5 dark:shadow-black/20 p-0.5">
            ...
            <span className="text-xl font-bold tracking-tight group-hover:text-emerald-600 dark:group-hover:text-emerald-400 transition-colors">
              GO-DATA
            </span>
          </Link>
      ...
      <main className="relative z-10 px-6">
        ...
        <section className="max-w-5xl mx-auto pt-20 pb-24 text-center">
          <p className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-emerald-50 dark:bg-emerald-950/30 text-emerald-700 dark:text-emerald-300 text-sm font-medium mb-8 border border-emerald-100 dark:border-emerald-900/50">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
            <Link
              href="/create-account"
              className="group inline-flex items-center gap-2 px-8 py-4 rounded-xl bg-emerald-600 text-white text-base font-semibold hover:bg-emerald-700 transition-all shadow-lg shadow-emerald-600/25 hover:shadow-xl hover:shadow-emerald-600/30 hover:-translate-y-0.5"
            >
        ...
        <section id="demo" className="max-w-6xl mx-auto pb-32">
          <div className="relative rounded-2xl border border-gray-200/80 dark:border-gray-800/80 bg-white/80 dark:bg-[#1c1e20]/80 backdrop-blur-sm shadow-2xl shadow-gray-900/5 dark:shadow-black/30 overflow-hidden">
            ...
            <div className="p-6 md:p-8 bg-gradient-to-br from-gray-50 to-white dark:from-[#1c1e20] dark:to-[#1c1e20]">
              <div className="grid md:grid-cols-3 gap-4 mb-6">
                {[
                  ...
                  <div key={stat.label} className="p-5 rounded-xl bg-white dark:bg-[#242628] border border-gray-100 dark:border-gray-800">
              ...
              {/* Chart placeholder */}
              <div className="p-6 rounded-xl bg-white dark:bg-[#242628] border border-gray-100 dark:border-gray-800">
                ...
                <div className="flex items-end gap-2 h-32">
                  {[40, 65, 45, 80, 55, 90, 70].map((h, i) => (
                    <div key={i} className="flex-1 bg-gradient-to-t from-emerald-600 to-emerald-400 rounded-t-md" style={{ height: `${h}%` }} />
                  ))}
                </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={item.step} className="relative group">
                <div className="absolute -top-4 -left-2 text-7xl font-black text-gray-100 dark:text-gray-900 select-none group-hover:text-emerald-100 dark:group-hover:text-emerald-950 transition-colors">
                  {item.step}
                </div>
                <div className="relative p-6 rounded-2xl bg-white dark:bg-[#1c1e20] border border-gray-200 dark:border-gray-800 hover:border-emerald-200 dark:hover:border-emerald-900 transition-all hover:-translate-y-1 hover:shadow-xl hover:shadow-emerald-600/5">
        ...
        <section className="max-w-5xl mx-auto pb-32">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {[
              ...
              <div key={feature.title} className="p-6 rounded-2xl bg-white dark:bg-[#1c1e20] border border-gray-200 dark:border-gray-800 hover:border-emerald-200 dark:hover:border-emerald-900 transition-all group">
                <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-emerald-50 to-teal-50 dark:from-emerald-950/30 dark:to-teal-950/30 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
            ...
            {plans.map((plan) => (
              <div
                ...
                className={`relative p-8 rounded-2xl border transition-all hover:-translate-y-1 ${plan.highlighted
                  ? "bg-gradient-to-br from-emerald-600 to-emerald-700 border-emerald-500 text-white shadow-2xl shadow-emerald-600/25"
                  : "bg-white dark:bg-[#1c1e20] border-gray-200 dark:border-gray-800 hover:border-emerald-200 dark:hover:border-emerald-900"
                  }`}
              >
                {plan.highlighted && (
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2 px-3 py-1 rounded-full bg-white text-emerald-600 text-xs font-semibold shadow-lg">
                    Populaire
                  </div>
                )}
                <h3 className={`text-xl font-bold mb-1 ${plan.highlighted ? "text-white" : ""}`}>{plan.name}</h3>
                <p className={`text-sm mb-4 ${plan.highlighted ? "text-emerald-100" : "text-gray-500 dark:text-gray-400"}`}>
                  {plan.description}
                </p>
                ...
                <ul className="space-y-3 mb-8">
                  {plan.features.map((feature) => (
                    <li key={feature} className="flex items-center gap-3 text-sm">
                      <Check className={`h-4 w-4 flex-shrink-0 ${plan.highlighted ? "text-emerald-200" : "text-emerald-500"}`} />
                      <span className={plan.highlighted ? "text-emerald-50" : "text-gray-600 dark:text-gray-300"}>
                        {feature}
                      </span>
                    </li>
                  ))}
        ...
        <section className="max-w-4xl mx-auto pb-32">
          <div className="relative p-12 md:p-16 rounded-3xl bg-gradient-to-br from-gray-900 to-gray-800 dark:from-[#242628] dark:to-[#1c1e20] text-white text-center overflow-hidden">
            {/* Decorative squares */}
