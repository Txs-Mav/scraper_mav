    ...
    <Layout>
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-10 sm:py-14">
        ...
        <section data-onboarding="profile" className="rounded-2xl border border-[var(--color-border-secondary)] bg-[var(--color-background-primary)] p-6 sm:p-8 mb-6">
          ...
          <div className="flex items-center gap-6 mb-8 pb-8 border-b border-[var(--color-border-tertiary)]">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-xl font-semibold text-[var(--color-text-primary)] truncate">{user.name}</p>
              <p className="text-sm text-[var(--color-text-secondary)] truncate mt-0.5">{user.email}</p>
          ...
          <div className="grid sm:grid-cols-2 gap-5 mb-6">
            <div>
              <label className="block text-sm font-medium text-[var(--color-text-primary)] mb-2">{t("name")}</label>
              <input
                type="text"
                value={profileName}
            ...
            <div>
              <label className="block text-sm font-medium text-[var(--color-text-primary)] mb-2">{t("email")}</label>
              <input
                type="email"
                value={profileEmail}
          ...
          <div className="flex items-center justify-between pt-4 border-t border-[var(--color-border-tertiary)]">
            <button
              ...
              className="inline-flex items-center gap-2 text-sm text-[var(--color-text-secondary)] hover:text-gray-900 dark:hover:text-white transition-colors"
            >
        ...
        <section className="rounded-2xl border border-[var(--color-border-secondary)] bg-[var(--color-background-primary)] p-6 sm:p-8 mb-6">
          ...
          <div className="flex items-center justify-between py-4 border-b border-[var(--color-border-tertiary)]">
            <div className="flex items-center gap-4">
              <div className="p-2 rounded-lg bg-[var(--color-background-primary)]">
              ...
              <div>
                ...
                <p className="text-xs text-[var(--color-text-secondary)] mt-0.5">{t("settings.languageDesc")}</p>
              </div>
            </div>
            <div className="inline-flex items-center rounded-xl border border-[var(--color-border-secondary)] bg-[var(--color-background-secondary)] p-1 gap-1">
              <button
                type="button"
                onClick={() => setLocale("fr")}
                className={`px-3.5 py-2 rounded-lg text-sm font-semibold transition-all ${
                  locale === "fr"
                    ? "bg-white dark:bg-white/[0.12] text-[var(--color-text-primary)] shadow-sm"
                    : "text-[var(--color-text-secondary)] hover:text-gray-600 dark:hover:text-gray-300"
                }`}
              >
                {t("settings.french")}
              </button>
          ...
          <div className="flex items-center justify-between py-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-sm font-medium text-[var(--color-text-primary)]">{t("settings.search")}</p>
                <p className="text-xs text-[var(--color-text-secondary)] mt-0.5">{t("settings.searchDesc")}</p>
              </div>
            </div>
            <button
              type="button"
              onClick={() => window.dispatchEvent(new KeyboardEvent("keydown", { key: "k", metaKey: true, bubbles: true }))}
              className="inline-flex items-center gap-2 px-4 py-2 rounded-xl border border-[var(--color-border-secondary)] text-sm font-medium text-[var(--color-text-primary)] hover:bg-[var(--color-background-hover)] hover:border-gray-300 dark:hover:border-gray-700 transition-all"
            >
              <kbd className="flex items-center gap-0.5 px-1.5 py-0.5 rounded bg-gray-200 dark:bg-white/[0.06] text-[10px] font-medium text-[var(--color-text-secondary)]">
        ...
        <section className="rounded-2xl border border-[var(--color-border-secondary)] bg-[var(--color-background-primary)] p-6 sm:p-8 mb-6">
          ...
          <div className="space-y-1">
            ...
            <div className="flex items-center justify-between py-4 border-b border-[var(--color-border-tertiary)]">
              <div className="flex items-center gap-4">
                <div className="p-2 rounded-lg bg-[var(--color-background-primary)]">
                  <FileDown className="h-4 w-4 text-[var(--color-text-secondary)]" />
                </div>
                <div>
                  <p className="text-sm font-medium text-[var(--color-text-primary)]">{t("settings.exportData")}</p>
            ...
            <div className="flex items-center justify-between py-4">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-[var(--color-text-secondary)] mt-0.5">{t("settings.deleteAccountDesc")}</p>
                </div>
              </div>
              <button
                type="button"
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center px-4" onClick={(e) => { if (e.target === e.currentTarget) setShowPasswordModal(false) }}>
          <div className="bg-[var(--color-background-primary)] rounded-2xl max-w-md w-full p-6 sm:p-8 shadow-2xl shadow-gray-900/10 dark:shadow-black/40 border border-[var(--color-border-tertiary)]">
            <div className="flex items-center justify-between mb-6">
              ...
              <button type="button" onClick={() => setShowPasswordModal(false)} className="p-1.5 rounded-lg text-gray-400 hover:text-gray-600 dark:hover:text-gray-200 hover:bg-[var(--color-background-hover)] transition">
                <X className="h-5 w-5" />
              </button>
            </div>
            <div className="space-y-4">
              <div>
                <label className="block text-sm font-medium text-[var(--color-text-primary)] mb-2">{t("settings.newPassword")}</label>
                <input
                  type="password"
                  value={newPassword}
              ...
              <div>
                <label className="block text-sm font-medium text-[var(--color-text-primary)] mb-2">{t("settings.confirmPassword")}</label>
                <input
                  type="password"
              ...
              <div className="flex gap-3 pt-3">
                <button
                  ...
                  className="flex-1 px-4 py-2.5 rounded-xl border border-[var(--color-border-secondary)] text-sm font-medium text-[var(--color-text-primary)] hover:bg-[var(--color-background-hover)] transition"
                >
                  {t("cancel")}
                </button>
                <button
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center px-4" onClick={(e) => { if (e.target === e.currentTarget) setShowDeleteModal(false) }}>
          <div className="bg-[var(--color-background-primary)] rounded-2xl max-w-md w-full p-6 sm:p-8 shadow-2xl shadow-gray-900/10 dark:shadow-black/40 border border-[var(--color-border-tertiary)]">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <h3 className="text-lg font-semibold text-[var(--color-text-primary)]">{t("settings.deleteAccountTitle")}</h3>
                <p className="text-sm text-[var(--color-text-secondary)]">{t("settings.deleteAccountWarning")}</p>
              </div>
            </div>
            <div className="space-y-4">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-3 pr-11 rounded-xl border border-[var(--color-border-secondary)] bg-[var(--color-background-secondary)] text-sm text-[var(--color-text-primary)] placeholder-[var(--color-text-tertiary)] focus:outline-none focus:ring-2 focus:ring-red-500/20 focus:border-red-500/50 transition"
                />
