...
const config = DEALER_CAMPAIGNS.excelmoto
...
export const metadata: Metadata = {
  title: "Go-Data × Excel Moto",
  description:
    "Démo privée Go-Data pour Excel Moto : surveillance de prix, analyse et stratégie de pricing sur l'inventaire réel.",
  robots: { index: false, follow: false },
}

export default async function ExcelMotoPage() {
