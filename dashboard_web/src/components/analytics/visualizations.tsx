  ...
  return (
    <div className="bg-[#1c1e20] border border-[#343638] rounded-xl px-4 py-3 shadow-2xl max-w-xs">
      ...
      <div className="space-y-1 text-xs">
        ...
        <div className="h-px bg-[#343638] my-1" />
        <div className="flex justify-between gap-6">
          <span className="text-gray-400">{t("ap.gap")}</span>
          <span className={`font-bold ${d.ecart < 0 ? 'text-[#3B6D11]' : d.ecart > 0 ? 'text-[#A32D2D]' : 'text-gray-400'}`}>
            {d.ecart > 0 ? '+' : ''}{d.ecart}%
    ...
    <div className="bg-[#1c1e20] border border-[#343638] rounded-xl px-4 py-3 shadow-2xl">
      ...
      <div className="space-y-1 text-xs">
        <div className="flex justify-between gap-6">
          ...
          <span className={`font-bold ${d.agressivite > 0 ? 'text-[#3B6D11]' : d.agressivite < 0 ? 'text-[#A32D2D]' : 'text-gray-400'}`}>
      ...
      <div className="bg-white dark:bg-[#222222] rounded-2xl border border-gray-200 dark:border-[#3A3A3A] p-6">
        ...
        {hasProductData ? (
          <>
            ...
            {/* Legend */}
            <div className="mt-4 flex items-center justify-center gap-6 text-xs text-gray-500 dark:text-[#B0B0B0]">
