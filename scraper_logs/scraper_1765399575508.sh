...
nohup python3 "-m" "scraper_ai.main" "--reference" "https://www.mvmmotosport.com/fr/" "https://www.mvmmotosport.com/fr/" > "/Users/maverickmenard/project/projet_mvm/scraper_mav/scraper_logs/scraper_1765399575508.log" 2>&1 &
PYTHON_PID=$!
...
if kill -0 $PYTHON_PID 2>/dev/null; then
  ...
  cat > "/Users/maverickmenard/project/projet_mvm/scraper_mav/scraper_logs/scraper_1765399575508.lock" << LOCKEOF
{
  "pid": $PYTHON_PID,
  "startTime": 1765399575508,
